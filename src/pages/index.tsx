        ...
        <ul>
          {latestEpisodes.map((episode, index) => (
            <li key={episode.id}>
              ...
              <button type="button" onClick={() => playerCtx.playList(episodeList, index)}>
            ...
            {allEpisodes.map((episode, index) => (
              <tr key={episode.id}>
                ...
                <td>
                  <button
                    type="button"
                    onClick={() => playerCtx.playList(episodeList, index + latestEpisodes.length)}
                  >
